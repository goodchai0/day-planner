                ...
                `<div class='col-md-12 pb-2 mb-2 timeBlock' data-block='${i}'>
                    <form class='form-inline m-2 p-2' id='activity-form'>
                        ...
                        <div class='col-xs-12 col-md-8'>
                            <input type='text' class='form-control' data-hour='${i}' id='work' style='width:100%;'placeholder='Eat, sleep, code ,repeat' minlength='2' maxlength='50'></input>
                        </div>

                        <div class='col-xs-12 col-md-2 pt-1'>
                            <button type='button' class='button create' id='btn-submit' data-hour='${i}'>Create</button>
                        </div>
                    </form>
